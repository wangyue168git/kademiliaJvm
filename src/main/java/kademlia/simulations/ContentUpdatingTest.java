...
public class ContentUpdatingTest
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            conte = kad2.get(gp);
            System.out.println("Content Found: " + new DHTContentImpl().fromSerializedForm(conte.getContent()).toString());
            System.out.println("Content Metadata: " + conte.getContentMetadata().toString());
